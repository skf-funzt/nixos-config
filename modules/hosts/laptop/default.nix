...
}:
{
  ...
  # Hibernation — swap on LUKS-encrypted partition.
  # resumeDevice is set to /dev/mapper/cryptswap by disko's resumeDevice = true.
  # Unlocked via keyfile stored on root (generated by convert-swap-to-luks.sh).
  # Root is mounted at /sysroot in stage 1 → keyfile path reflects that.
