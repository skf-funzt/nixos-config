...
echo "╚═══════════════════════════════════════════════════════════════╝"
echo ""
echo "Step 06 generated hardware-configuration.nix at:"
echo "  /mnt/etc/nixos/hardware-configuration.nix"
echo ""
echo "Find the Btrfs UUID (look for the device= line with your disk),"
echo "or run:  sudo blkid /dev/mapper/cryptroot"
echo ""
echo "Then update it in the flake:"
echo "  /mnt/etc/nixos/modules/system/btrfs-laptop.nix"
echo ""
...
echo ""
echo "Next:"
echo "  1. Set root password if nixos-install prompted you"
echo "  2. Reboot:  sudo reboot"
echo "  3. After reboot, run:"
